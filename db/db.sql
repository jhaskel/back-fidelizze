...
CREATE TABLE agendamento (
	...
	id_user BIGINT NULL,	
	dia VARCHAR(180) NOT NULL ,	
	hora VARCHAR(180) NOT NULL ,	
...
DROP TABLE IF EXISTS grupo_has_especialistas CASCADE;
CREATE TABLE grupo_has_especialistas(
	id_grupo BIGSERIAL NOT NULL,
	id_espe BIGSERIAL NOT NULL,
	created_at TIMESTAMP(0) NOT NULL,
	updated_at TIMESTAMP(0) NOT NULL,
	FOREIGN KEY(id_grupo) REFERENCES grupo(id) ON UPDATE CASCADE ON DELETE CASCADE,
	FOREIGN KEY(id_espe) REFERENCES especialistas(id) ON UPDATE CASCADE ON DELETE CASCADE,
	PRIMARY KEY(id_grupo, id_espe)
);
/*
SELECT
        G.*,
